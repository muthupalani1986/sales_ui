    ...
    fileReader.onload = (e) => {
      ...
      for (let line = 1; line < lines.length; line++) {
        ...
        for (let tab = 0; tab < tabs.length; tab++) {
            ...
            settlement["settlement-start-date"]=tabs[1].length==0 ? "":moment(tabs[1]).format('YYYY-MM-DD HH:MM:SS');
            settlement["settlement-end-date"]=tabs[2].length==0 ? "":moment(tabs[2]).format('YYYY-MM-DD HH:MM:SS');
            settlement["deposit-date"]=tabs[3].length==0 ? "":moment(tabs[3]).format('YYYY-MM-DD HH:MM:SS');
            ...
            settlement["posted-date"]=tabs[17].length==0 ? "":moment(tabs[17]).format('YYYY-MM-DD HH:MM:SS');
